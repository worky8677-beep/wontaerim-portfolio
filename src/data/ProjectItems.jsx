...
export const projects = [
  {
    ...
    duration: "2주",
    contribution: "40%",
    description: `브루다 커피 앱을 리디자인한 팀 프로젝트입니다. 앱스토어 리뷰 분석과 직접 사용 경험을 바탕으로 퀵오더 카드 수 제한, 결제 시 비밀번호 입력 불편 등 실사용자 문제를 반영해 메인화면과 결제 플로우를 개선했습니다. 디자인 리드로서 업무를 분배하는 과정에서 팀원마다 결과물 스타일이 달라지는 문제가 있었습니다. 공통 컴포넌트를 직접 제작하고 크기·간격이 레이아웃과 일치하는지 함께 검토하는 방식으로 해결해 일관된 디자인을 완성했습니다.`,
    image: brewdaImg,
    bgImage: brewdaBgImg,
    embed:
