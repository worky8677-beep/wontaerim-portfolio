...
export function Footer() {
  return (
    <footer id="contact" className="relative z-10 overflow-x-hidden min-h-[500px] md:min-h-[600px] lg:min-h-[700px] bg-linear-[to_bottom] from-mint to-white">
      ...
      {/* 콘텐츠 */}
      <div
        className="relative z-10 max-w-[1280px] mx-auto px-6 desktop:px-10 flex flex-col desktop:flex-row items-center min-h-[500px] desktop:min-h-[700px]"
        style={{ paddingTop: `${r * 2}px` }}
      >
        {/* 왼쪽: 프로필 사진 */}
        <div className="flex w-full md:w-1/2 items-end justify-center md:justify-start h-[260px] md:h-[420px] lg:h-[560px]">
          <img
            src={subprofile}
            alt="원태림"
        ...
        {/* 오른쪽: 텍스트 */}
        <div className="w-full desktop:w-1/2 flex flex-col gap-4 desktop:gap-6 pb-10 desktop:pb-0">
          <p className="font-a2z font-bold text-h5 md:text-h4 lg:text-h3 text-forest">
            Let&apos;s talk!
          </p>
          <CopyItem
            text="trw9701@gmail.com"
            className="font-a2z font-bold text-[32px] md:text-[48px] lg:text-[64px] leading-tight text-forest tracking-[-1.6px] hover:text-dove transition-colors text-left"
          >
            trw9701@gmail.com
          </CopyItem>
          <CopyItem
            text="010-2256-7019"
            className="font-a2z font-bold text-h5 md:text-[28px] lg:text-h4 text-mine hover:text-dove transition-colors text-left"
          >
            010-2256-7019
          </CopyItem>
